package com.revature.spring.dtos.responses;
...
public class ReimbursementResponse {
    ...
    public ReimbursementResponse(Reimbursement rmb) {
        ...
        this.author_id = rmb.getAuthor_id().getId();
        if (rmb.getResolver_id() != null)
             this.resolver_id = rmb.getResolver_id().getId();
        this.status_id = rmb.getStatus_id().getId();
